        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={handleChange}
              placeholder="Enter a short description of your brew technique"
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              type="number"
              name="coffeeAmount"
              value={newForm.coffeeAmount}
              onChange={handleChange}
              placeholder="Enter an amount of grams"
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              value={newForm.brewTimeSeconds}
              onChange={handleChange}
              placeholder="Enter the amount of time in seconds"
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              value={newForm.requiredEquipment}
              onChange={handleChange}
              placeholder="Enter equipment seperated by a comma EXAMPLE: 'Kettle, Water '"
            />
          </Form.Group>
          ...
          <Form.Group className="mb-3">
            ...
            <Form.Control
              ...
              onChange={handleChange}
              placeholder="Enter individual steps seperated by a comma"
            />
          </Form.Group>
